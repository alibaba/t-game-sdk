...
struct AkDeviceData
{
	...
	AkUInt32			uPeakUsed;			///< Memory peak since monitoring started
	AkUInt32			uNumViewsAvailable;	///< IO memory references available
	...
	AkUInt32			uMaxCachePinnedBytes;  ///< Number of bytes that can be pinned into cache.
};
...
struct AkStreamData
{
    ...
    AkUInt32            uVirtualBufferingSize;		///< Size of available data (specific to IAkAutoStream)
