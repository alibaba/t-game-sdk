...
#define __atomic_store_n_native(ptr, val, memorder) __atomic_store_n_size(ptr, (long long)val, memorder, sizeof(val))
...
int __atomic_compare_exchange_n_float(volatile float * ptr, float* expected, float desired, int weak, int success_memorder, int failure_memorder);
int __atomic_compare_exchange_n_double(volatile double * ptr, double* expected, double desired, int weak, int success_memorder, int failure_memorder);
